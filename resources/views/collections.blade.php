<x-app-layout title="Our Collections | AVAL JEWELS">
    ...
    <!-- Page Header -->
    <section class="relative pt-48 pb-32 bg-brand-maroon overflow-hidden">
    ...
    <!-- Filters placeholder -->
    <div class="bg-brand-cream border-b border-brand-maroon/5 sticky top-20 z-40">
        <div class="container mx-auto px-6 py-8">
            <div class="flex flex-wrap items-center justify-center space-x-12">
                ...
                <a href="#" class="text-[0.65rem] uppercase tracking-widest text-brand-maroon/40 hover:text-brand-maroon transition-colors font-bold">Bridal</a>
                <a href="#" class="text-[0.65rem] uppercase tracking-widest text-brand-maroon/40 hover:text-brand-maroon transition-colors font-bold">Earrings</a>
                <a href="#" class="text-[0.65rem] uppercase tracking-widest text-brand-maroon/40 hover:text-brand-maroon transition-colors font-bold">Necklaces</a>
                <a href="#" class="text-[0.65rem] uppercase tracking-widest text-brand-maroon/40 hover:text-brand-maroon transition-colors font-bold">Bangles</a>
            </div>
        </div>
    </div>
    ...
    <section class="py-32 bg-brand-dark text-white text-center relative overflow-hidden">
        <div class="container mx-auto px-6 relative z-10">
            ...
            <a href="/contact" class="inline-flex items-center text-brand-gold text-xs font-bold uppercase tracking-[0.3em] group">
