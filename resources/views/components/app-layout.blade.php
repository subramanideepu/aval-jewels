...
<head>
    ...
    <meta name="description" content="{{ $metaDescription ?? 'Discover AVAL JEWELS - Chennai\'s premier boutique for handcrafted gold, diamond, and bridal jewelry. Explore our collections and wear your confidence.' }}">
    ...
    <meta property="og:image" content="{{ $ogImage ?? asset('images/hero.png') }}">
    ...
    <meta property="twitter:image" content="{{ $ogImage ?? asset('images/hero.png') }}">
