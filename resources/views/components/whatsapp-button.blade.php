<a href="https://wa.me/919876543210" 
   ...
   target="_blank">
    ...
    <div class="absolute right-20 bg-white text-brand-maroon px-6 py-2 rounded-lg text-xs font-bold uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap shadow-xl">
        Consult on WhatsApp
    </div>
</a>
