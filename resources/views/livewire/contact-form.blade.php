<div>
    ...
    <form wire:submit.prevent="submit" class="space-y-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="space-y-2">
                <label class="text-[0.6rem] uppercase tracking-widest text-brand-maroon/60 font-bold">Full Name</label>
            ...
            <div class="space-y-2">
                <label class="text-[0.6rem] uppercase tracking-widest text-brand-maroon/60 font-bold">Email Address</label>
        ...
        <div class="space-y-2">
            <label class="text-[0.6rem] uppercase tracking-widest text-brand-maroon/60 font-bold">Subject</label>
        ...
        <div class="space-y-2">
            <label class="text-[0.6rem] uppercase tracking-widest text-brand-maroon/60 font-bold">Message</label>
