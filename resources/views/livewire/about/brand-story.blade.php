        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            <div class="space-y-10">
                <div class="space-y-4">
                    ...
                    <h2 class="text-5xl md:text-6xl font-heading text-brand-maroon leading-tight">Three Decades of<br>Pure Brilliance</h2>
                </div>
                
                <p class="text-brand-maroon/70 text-lg font-body leading-relaxed font-light">
                    Founded in 1990, <span class="font-bold text-brand-maroon">AVAL JEWELS</span> began with a single vision: to create jewelry that doesn't just adorn, but empowers. Our journey from a boutique workshop to Chennai's premier luxury jeweler is paved with trust, artistry, and an unwavering commitment to quality.
                </p>
                ...
                <div class="grid grid-cols-2 gap-10 pt-6">
                    <div>
                        ...
                        <span class="text-[0.6rem] uppercase tracking-widest text-brand-maroon/40 font-bold">Hallmarked Gold</span>
                    </div>
                    <div>
                        <span class="block text-4xl font-heading text-brand-gold mb-2">Bespoke</span>
                        <span class="text-[0.6rem] uppercase tracking-widest text-brand-maroon/40 font-bold">Custom Designs</span>
                    </div>
                </div>
            </div>
        </div>
