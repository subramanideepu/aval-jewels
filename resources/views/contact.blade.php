<x-app-layout title="Contact Us | AVAL JEWELS">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-16">
                ...
                <div class="lg:col-span-5 space-y-16">
                    <div>
                        ...
                        <h1 class="text-5xl md:text-7xl font-heading text-brand-green leading-tight mb-8">Reach the<br>Concierge</h1>
                        <p class="text-brand-green/60 font-body text-lg leading-relaxed max-w-md">
                    ...
                    <div class="space-y-10">
                        <div class="flex items-start space-x-6">
                            ...
                            <div>
                                <h4 class="text-brand-green font-heading text-xl mb-2">Our Boutique</h4>
                                <p class="text-brand-green/60 font-body text-sm leading-relaxed">45, GST Road, Pallavaram,<br>Chennai, Tamil Nadu - 600043</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-6">
                            ...
                            <div>
                                <h4 class="text-brand-green font-heading text-xl mb-2">Call Us</h4>
                                <p class="text-brand-green/60 font-body text-sm">+91 98765 43210</p>
                                <p class="text-brand-green/60 font-body text-sm">+91 44 2233 4455</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-6">
                            ...
                            <div>
                                <h4 class="text-brand-green font-heading text-xl mb-2">Email Us</h4>
                                <p class="text-brand-green/60 font-body text-sm">concierge@avaljewels.com</p>
                                <p class="text-brand-green/60 font-body text-sm">support@avaljewels.com</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="h-[500px] w-full grayscale contrast-125 brightness-90 relative">
        ...
        <div class="absolute inset-0 pointer-events-none border-y border-brand-green/10"></div>
    </section>
</x-app-layout>
